        ...
        try {
            ...
            if (res.ok) {
                ...
                const list = Array.isArray(data)
                    ? data
                    : data?.medicines || data?.data?.medicines || [];
...
function ReportsTable({
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            {authError && (
                <div className="mx-6 my-4 flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600">
                                ...
                                <td className="px-6 py-3">
                                    <div className="flex gap-2">
                                        <ActionBtn
                                            ...
                                            disabled={acting !== null && acting.startsWith(r.id)}
